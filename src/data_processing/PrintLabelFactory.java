...
//        lock.lock();
//        try {
//            String ps = UsbConnector.getPrinterStatus(serial);
//            if (ps.contains("|")) {
//                ChannelMap.writeMessageToClient(clientRemote, ErrorCatcher.CatchConnectError(ps));
//                return;
//            }
//            String ws = UsbConnector.writeToPrinter(serial, data, data.length);
//            if (ws.contains("|")) {
//                ChannelMap.writeMessageToClient(clientRemote, ErrorCatcher.CatchConnectError(ws));
//                return;
//            }
//            String readData = UsbConnector.read(serial, 10000, 256);
...
//                    ps = UsbConnector.getPrinterStatus(serial);
//                    if (ps.contains("|")) {
//                        ChannelMap.writeMessageToClient(clientRemote, ErrorCatcher.CatchConnectError(ps));
//                    }else {
