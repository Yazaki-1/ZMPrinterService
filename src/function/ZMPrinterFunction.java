...
public interface ZMPrinterFunction {
    ...
    void getPrinterStatus(String address) throws ConnectException;

    String readTagData(String funcParams_One, LabelType labelType, Map<String, Integer> configuration, Integer timeout, int buffer_size) throws ConnectException, IllegalAccessException;
}
